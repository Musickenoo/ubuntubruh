...
// #define K_P 0.5                             // P 0.6constant
// #define K_I 0.5                             // I 0.8constant
// #define K_D 0.3                             // D 0.5constant

#define K_P 0.6                             // P 0.6constant
#define K_I 0.8                             // I 0.8constant
#define K_D 0.5                             // D 0.5constant
...
#define COUNTS_PER_REV1 100000              // wheel1 encoder's no of ticks per rev
#define COUNTS_PER_REV2 100000              // wheel2 encoder's no of ticks per rev
#define COUNTS_PER_REV3 100000              // wheel3 encoder's no of ticks per rev
#define COUNTS_PER_REV4 100000              // wheel4 encoder's no of ticks per rev
...
// MOTOR PINS
  ...
  #define MOTOR2_PWM 22 //Pin no 21 is not a PWM pin on Teensy 4.x, you can swap it with pin no 1 instead.
